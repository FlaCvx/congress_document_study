...
if __name__ == "__main__":
    ...
    os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "./credentials.json"  # Instantiates a client
    client = vision.ImageAnnotatorClient()

    files_paths = list_all_pngs_files(args.path_pngs)
    for file_path in files_paths:
        new_directory = Path(file_path.replace("concat_pages","text_volumes")).parent
        new_name = file_path.replace("concat_pages","text_volumes").replace("png","txt")
